...
def eval_model(args):
    ...
    for line in tqdm(questions):
        ...
        audio_file = os.path.join(args.audio_folder, line["audio"])
        qs = line["question"]
        ans = line["answer"]
        cur_prompt = qs
        ...
        audio_tensor = audio_processor(audio_file, return_tensors='pt')['pixel_values'][0]
        ...
        with torch.inference_mode():
            output_ids = model.generate(
                input_ids,
                images=audio_tensor.unsqueeze(0).half().cuda(),
