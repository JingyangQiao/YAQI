LLM_VERSION="./checkpoints/llava-llama-2-7b-chat-LanguageBind-llava_llama_2-finetune-video-mirror"
...
deepspeed videollava/train/train_mem.py \
    ...
    --data_path ./Dataset/Music/music_instruct_10k.json ./Dataset/Replay/LLaMA-2-7b/Image.json ./Dataset/Replay/LLaMA-2-7b/Video.json ./Dataset/Replay/LLaMA-2-7b/Audio.json ./Dataset/Replay/LLaMA-2-7b/Text.json \
