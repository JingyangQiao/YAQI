LLM_VERSION="./checkpoints/llava-llama-2-7b-chat-LanguageBind-plain-pretrain-audio-mirror/checkpoint-xxxx"
...
deepspeed videollava/train/train_mem.py \
    ...
    --data_path ./Dataset/Audio/audio_instruct_80k.json ./Dataset/Replay/LLaMA-2-7b/Image.json ./Dataset/Replay/LLaMA-2-7b/Text.json \
