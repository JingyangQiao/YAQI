...
deepspeed videollava/train/train_mem.py \
    ...
    --data_path ./Dataset/Image/llava_v1_5_image_624k.json ./Dataset/Replay/LLaMA-2-7b/Text.json \
    --image_folder ./Dataset/Image \
    --image_tower ${IMAGE_MODEL_VERSION} \
    --pretrain_mm_mlp_adapter ./checkpoints/llava-llama-2-7b-chat-LanguageBind-plain-pretrain-vision-mirror/mm_projector.bin \
