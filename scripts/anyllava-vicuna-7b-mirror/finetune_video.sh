LLM_VERSION="./checkpoints/llava-vicuna-7b-v1.5-LanguageBind-plain-pretrain-video-mirror/checkpoint-xxxx"
...
deepspeed videollava/train/train_mem.py \
    ...
    --data_path ./Dataset/Video/llava_v1_5_video_730k.json ./Dataset/Replay/Vicuna-v1.5-7b/Image.json ./Dataset/Replay/Vicuna-v1.5-7b/Audio.json ./Dataset/Replay/Vicuna-v1.5-7b/Text.json \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-$LLM_VERSION_CLEAN-$VIDEO_MODEL_VERSION_CLEAN-$PROMPT_VERSION-finetune-video-mirror \
    --num_train_epochs 6 \
