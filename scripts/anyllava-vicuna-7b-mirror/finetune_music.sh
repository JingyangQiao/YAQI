LLM_VERSION="./checkpoints/llava-vicuna-7b-v1.5-LanguageBind-v1-finetune-video-mirror"
...
deepspeed videollava/train/train_mem.py \
    ...
    --data_path ./Dataset/Music/music_instruct_10k.json ./Dataset/Replay/Vicuna-v1.5-7b/Image.json ./Dataset/Replay/Vicuna-v1.5-7b/Audio.json ./Dataset/Replay/Vicuna-v1.5-7b/Video.json ./Dataset/Replay/Vicuna-v1.5-7b/Text.json \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-$LLM_VERSION_CLEAN-$AUDIO_MODEL_VERSION_CLEAN-$PROMPT_VERSION-finetune-music-mirror \
    --num_train_epochs 12 \
