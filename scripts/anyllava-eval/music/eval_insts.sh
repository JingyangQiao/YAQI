...
RESULT_DIR="./results/llama-2-7b-mirror/Music/Insts_Mirror_Music"

for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m videollava.eval.anyllava.model_audio_qa \
        --model-path $MODELPATH \
        --question-file ./Dataset/Audio/Nsynth/instrument_test.jsonl \
...
output_file=$RESULT_DIR/llama_2_7b_music_model_music_modality_instrument_dataset_mirror.jsonl
...
# python -m videollava.eval.anyllava.music.eval_insts \
