...
RESULT_DIR="./results/vicuna-v1.5-13b-mirror/Audio/Tacos_Mirror_Video"

for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m videollava.eval.anyllava.model_audio_qa \
        --model-path $MODELPATH \
        --question-file ./Dataset/Audio/tacos/annotations/tacos_test.jsonl \
...
output_file=$RESULT_DIR/vicuna_v1.5_13b_video_model_audio_modality_tacos_dataset_mirror.jsonl
...
# python -m videollava.eval.anyllava.audio.eval_tacos \
