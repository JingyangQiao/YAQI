...
RESULT_DIR="./results/llama-2-34b-mirror/Image/OCRVQA_Mirror_Audio"

for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m videollava.eval.anyllava.model_image_qa \
        --model-path $MODELPATH \
        --question-file ./Dataset/Image/ocr_vqa/ocrvqa_test.jsonl \
        --image-folder ./Dataset/Image/ocr_vqa \
...
output_file=$RESULT_DIR/llama_2_34b_audio_model_image_modality_ocrvqa_dataset_mirror.jsonl
...
python -m videollava.eval.anyllava.image.eval_ocrvqa \
